        ...
        <>
            ...
            <main className="pt-24">
                ...
                <section
                    ...
                    style={{
                        backgroundImage: `linear-gradient(rgba(10, 14, 26, 0.85), rgba(10, 14, 26, 0.7)), url('${earthworksData.featuredImage.url}')`,
                    }}
                >
                    <div className="container">
                        <div className="max-w-3xl">
                            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
                                {earthworksData.title}
                            </h1>
                            <p className="text-2xl text-neutral-200 mb-8">
                                {earthworksData.description}
                            </p>
                            <Link href="/contact">
                    ...
                    <div className="container">
                        <div className="max-w-4xl">
                            ...
                            <div className="grid md:grid-cols-3 gap-6">
                                {earthworksData.bulletPoints.map((point, index) => (
                                    <div
                                        key={index}
                ...
                <section className="py-20 bg-base-deep">
                    <div className="container">
                        ...
                        <div className="max-w-4xl mx-auto grid md:grid-cols-4 gap-8">
                            {[
                                { num: "01", title: "סקר ואפיון", desc: "בדיקת הקרקע והערכת היקף" },
                                { num: "02", title: "תכנון", desc: "הכנת תוכנית ביצוע מפורטת" },
                                { num: "03", title: "ביצוע", desc: "חפירה ועבודה עם ציוד מתקדם" },
                                { num: "04", title: "סיום", desc: "בקרת איכות ומסירה" },
                            ].map((step) => (
                                <div
                                    key={step.num}
                ...
                <section className="py-20">
                    <div className="container">
                        ...
                        <p className="text-neutral-300 mb-6">
                            ראו דוגמאות לפרויקטים שביצענו בתחום עבודות עפר וחפירה
                        </p>
                        <a
                            href="/projects"
                ...
                <section className="py-20 bg-base-deep border-t-2 border-accent-primary">
                    <div className="container text-center">
                        ...
                        <p className="text-xl text-neutral-300 mb-8 max-w-2xl mx-auto">
                            צרו קשר עכשיו לקבלת הצעת מחיר מפורטת והתחלה מהירה
                        </p>
                        <Link href="/contact">
                            <Button size="lg" className="text-lg px-8 shadow-xl shadow-blue-500/20">
                                צור קשר

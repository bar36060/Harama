        ...
        <>
            ...
            <main className="pt-24">
                ...
                <section
                    ...
                    style={{
                        backgroundImage: `linear-gradient(rgba(10, 14, 26, 0.85), rgba(10, 14, 26, 0.7)), url('${roadsData.featuredImage.url}')`,
                    }}
                >
                    ...
                    <div className="container">
                        <div className="max-w-4xl">
                            ...
                            <div className="grid md:grid-cols-3 gap-6">
                                {roadsData.bulletPoints.map((point, index) => (
                                    <div
                                        key={index}
                ...
                <section className="py-20 bg-base-deep">
                    <div className="container">
                        ...
                        <div className="max-w-4xl mx-auto grid md:grid-cols-4 gap-8">
                            {[
                                { num: "01", title: "סקר", desc: "בדיקת מצב הקרקע ותכנון מסלול" },
                                { num: "02", title: "הכנה", desc: "עבודות עפר וטיפול בבסיס" },
                                { num: "03", title: "סלילה", desc: "פיזור אספלט ודחיסה" },
                                { num: "04", title: "גימור", desc: "סימון ובדיקות איכות" },
                            ].map((step) => (
                ...
                <section className="py-20">
                    <div className="container">
                        ...
                        <p className="text-neutral-300 mb-6">
                            ראו דוגמאות לפרויקטי סלילה ואספלט שביצענו
                        </p>
                        <a
                            href="/projects"
                ...
                <section className="py-20 bg-base-deep border-t-2 border-accent-primary">
                    <div className="container text-center">
                        ...
                        <p className="text-xl text-neutral-300 mb-8 max-w-2xl mx-auto">
                            נשמח להציע לכם פתרון מקצועי ומהיר
                        </p>
                        <Link href="/contact">
                            <Button size="lg" className="text-lg px-8 shadow-xl shadow-blue-500/20">
                                צור קשר
